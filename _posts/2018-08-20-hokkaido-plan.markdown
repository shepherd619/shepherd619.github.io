...
## 체크리스트
- ~~포켓와이파이~~ **플레이와이파이 문자확인**
- 기내식 변경요청 (출발 24시간 전까지 전화)
- ~~항공 사전체크인~~
- ~~비자 시그니처로 쿠키젠 예약 요청~~ **만석으로 예약 실패!**
- 료칸 셔틀 예약
- 아고다 결제수단 변경 전
- ~~여행자보험 : [마이뱅크](https://travel.mibank.me/simple.php)~~ ₩ 14,556
- 그린카드 수령일자 제외 (문의중)
- 이은혜 라운지 이용권...
...
| 여정 | 시간 | 공항 | 편명 |
| :-------- | :-------- | :-------- | --------: |
| 인천 → 삿포로 | 09.09 14:20 ~ 17:00 | 인천공항 T1 → 신치토세 공항 | OZ174 |
| 삿포로 → 인천 | 09.13 18:10 ~ 21:10 | 신치토세 공항 → 인천공항 T1 | OZ173 |
...
---
- 삿포로 → 미즈노우타
    - [송영버스 시간표](http://www.mizunouta.com/en/access/#bypublicbus)
    - 치토세역발 송영버스를 11:05에 타면 12:15분에 호텔도착. 두시간 좀 안되게 남지만 그냥 짐놓고 주변산책하거나 빵집가면 될듯. 다음회차 버스는 3시 30분 호텔도착이라 체크인보다 한시간반 늦게도착함
    - 삿포로 → 치토세까지는 쾌속에어포트 타야됨. 1인당 1,360엔. 시간표 찾아보셈
        - [구글맵으로 찍은 삿포로역 → 치토세역 루트](https://www.google.com/maps/dir/Sapporo+Station,+4+Chome+Kita+6+Jonishi,+Kita,+Sapporo,+Hokkaido,+%EC%9D%BC%EB%B3%B8/%EC%A7%80%ED%86%A0%EC%84%B8+%EC%9D%BC%EB%B3%B8/@42.949009,141.361459,11z/am=t/data=!4m17!4m16!1m5!1m1!1s0x5f0b2974d2c3f903:0xa5e2b18cdd4a47a5!2m2!1d141.3507553!2d43.0686606!1m5!1m1!1s0x5f74df562104ad83:0x4bebc61a00669f14!2m2!1d141.652328!2d42.8281!2m2!7e2!8j1530279000!3e3)
- 미즈노우타 → 치토세 공항
    - 오전 10:20 출발차는 신치토세 공항에 11:35 도착
    - 오후 13:20 출발차는 JR치토세역에 14:45 도착 (1인당 870엔 쾌속에어포트나 2천엔돈 되는 택시비 내고 10분 가야 치토세 공항에 도착함)
    - 위 두가지 선택지에서 고민이 된다. 전자는 돈안들고 공항에서 오래 놀수있는 대신(네시간 반...) 료칸에서의 40분 포기ㅠㅠ 후자는 료칸에서의 40분을 더 얻는 대신 2천엔 마이너스에 공항여유시간이 1시간뿐
- 카약
    - 그냥 타보고 싶은데 시간이나 날씨에 따라 결정
...
- 삿포로역 스텔라 플레이스. 치카라메시보다는 아니지만 맛남. 포장가능에 좀 늦게까지함

>**[[아린코]](http://cafe.naver.com/jpnstory/2382258)** : 주먹밥
...
- 예약필수
- 바 자리로 가야 요리사 설명 들을수있음 (어눌한 한국어)
- 생맥이 맛있다함. 오타루맥주는 쓰다함.

>**[[스미스그릴]](http://otaruyataimura.jp/)** : 꼬치구이

- 꼬치술집인데 겁나마싯게생겼음 마스터가 한국김을 좋아한대
...
## 일정
- **9일** : 오후 다섯시 치토세공항 도착이라 저녁먹고 좀 돌아다니다 잠
    - 저녁후보
        - 잇핀이나 코부타야 부타동
        - 편의점 + 주변꼬치술집
        - 스프카레
...
## 쇼핑리스트
- 드럭스토어등 할인쿠폰 챙겨두기!! (마츠키요, 사츠도라, 빅카메라 등) : <https://cafe.naver.com/jpnstory/2507105>
- 동전파스 (할머니 요청)
- 곤약젤리 (엄마)
- 로이스 (엄마, 할머니)
- 르타오 치즈케익 (가족)
...
- 사라사티 란제리솝 (핏자국, 화장품 자국 같은거 잘지워진다함. 후기가 좀 갈림)
- 오페라 립틴트? 유명제품
- 호노미비스킨 (비염약)
- 트란시노 화이트닝 리페어크림 (미백크림. 걍 보이면 사기)
- 메이지 초코베이비 (존맛이라함)
- 백초환 (위염,소화불량,속쓰림,과음,식욕부진)

## 면세품 회수
- 신라아이파크 
    - 1건
        - [모로칸 빗, 써패스아이, 빈폴 사첼백, 베네피트 마스카라, 피지오겔 크림, 구찌향수, 베네피트 포어페셔널, 모로칸 오일]
        - 실구매액(카드혜택, 선불권 포함) : ₩ 374,480 (현카결제)
    - *28번 게이트 건너편, 4번 출국심사대 통과 시 왼쪽, 5번 출국심사대 통과 시 오른쪽 이동 후 바로 윗층(4층)*
- 신라 
    - 1건 
        - [조말론 잉글리쉬 페어 30ml, 조말론 넥타린 블로썸 30ml, 바비브라운 크러쉬드 립칼라, 입생로랑 따뚜아쥬 꾸뛰르]
        - 실구매액(카드혜택, 선불권 포함) : ₩ 128,644 (카뱅결제)
    - 공항면세점 선불카드 1만원 교환권있긴한데 쓸까? (당일 합산 30$ 이상 구매시 가능)
    - *C인도장 29번 게이트 앞 안내데스크 건너편 4층*
- 롯데 
    - 3건
        - [클리오 루즈힐 5]
            - 실구매액(카드혜택, 선불권 포함) : ₩ 2,593
        - [밀튼스텔리 시계, 나스 어데이셔스 1]
            - 실구매액(카드혜택, 선불권 포함) : ₩ 172,132 (현카결제)
        - [피치팝 1]
            - 실구매액(카드혜택, 선불권 포함) : ₩ 롯데포인트 1,108원
    - *B인도장 (26번 게이트 건너편 4층)*
